Feature: Recently Played Songs Store
  ...
  Scenario: Store and fetch recently played songs
    ...
    When the song "S2" is played by "UserA"
    Then the recently played songs for "UserA" should be "S2, S1, S2"

    When the song "S3" is played by "UserA"
    Then the recently played songs for "UserA" should be "S1, S2, S3"